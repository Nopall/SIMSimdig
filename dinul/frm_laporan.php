...
<body>
<form name="form1" method="post" action="aksi_laporan.php" class="panel panel-default"> 
  <table width="400" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#00FF00" bgcolor="#33CC00" class="table table-bordered"> 
    <tr bgcolor="#CCFFCC"> 
      <td height="50" colspan="2"><div align="center">INPUT DATA DAFTAR PENERIMAAN LAPORAN </div></td> 
    </tr> 
    </tr> 
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td>:<input name="tgl_pel" type="text" id="datepicker"></td>
	<tr bgcolor="#FFFFFF"> 
	...
	<tr bgcolor="#FFFFFF"> 
      <td height="40">LAPORAN TRAINING</td> 
      <td>: 
      <input name="lap" type="text" id="lap"></td> 
    </tr>
	<tr bgcolor="#FFFFFF"> 
      <td height="40">LINK WEBSITE SimulasiDigital.Seamolec.org</td> 
      <td>: 
